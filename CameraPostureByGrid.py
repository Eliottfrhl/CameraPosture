    ...
    if not os.path.exists(path):
        ...
        if cameraMatrix is None or distCoeffs is None:
            print("Calibration issue. Remove "+path+" and recalibrate your camera with CalibrateCamera.py.")
            exit()
    ...
    detector = aruco.ArucoDetector(dictionary=ARUCO_DICT,detectorParams=ARUCO_PARAMETERS)
    ...
    while(cam.isOpened()):
        ...
        if ret == True:
            ...
            corners, ids, rejectedImgPoints = detector.detectMarkers(gray, ARUCO_DICT, parameters=ARUCO_PARAMETERS)
